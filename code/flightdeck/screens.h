...
typedef struct _objects_t {
    ...
    lv_obj_t *btn_rescan;
    lv_obj_t *obj41;
    lv_obj_t *btn_copy_debug;
    lv_obj_t *obj42;
    lv_obj_t *btn_engine_mgmt;
    lv_obj_t *obj43;
    lv_obj_t *con_identity;
    lv_obj_t *lbl_identity_title_cap;
    lv_obj_t *lbl_ac_title;
    lv_obj_t *lbl_identity_model_cap;
    lv_obj_t *lbl_atc_model;
    lv_obj_t *lbl_identity_icao_cap;
    lv_obj_t *lbl_icao_type;
    lv_obj_t *con_capabilities_a;
    lv_obj_t *lbl_cap_pushback_cap;
    lv_obj_t *lbl_cap_pushback_yes;
    lv_obj_t *lbl_cap_pushback_no;
    lv_obj_t *lbl_cap_gpu_cap;
    lv_obj_t *lbl_cap_gpu_yes;
    lv_obj_t *lbl_cap_gpu_no;
    lv_obj_t *lbl_cap_deice_cap;
    lv_obj_t *lbl_cap_deice_yes;
    lv_obj_t *lbl_cap_deice_no;
    lv_obj_t *con_capabilities_b;
    lv_obj_t *lbl_cap_antiice_cap;
    lv_obj_t *lbl_cap_antiice_yes;
    lv_obj_t *lbl_cap_antiice_no;
    lv_obj_t *lbl_cap_autostart_cap;
    lv_obj_t *lbl_cap_autostart_yes;
    lv_obj_t *lbl_cap_autostart_no;
    lv_obj_t *lbl_cap_exits_cap;
    lv_obj_t *lbl_cap_exits_yes;
    lv_obj_t *lbl_cap_exits_no;
    lv_obj_t *con_live_state;
    lv_obj_t *lbl_state_pushback_cap;
    lv_obj_t *lbl_state_pushback;
    lv_obj_t *lbl_state_exit1_cap;
    lv_obj_t *lbl_state_exit1;
    lv_obj_t *lbl_state_exit2_cap;
    lv_obj_t *lbl_state_exit2;
    lv_obj_t *con_subscriptions;
    lv_obj_t *lbl_subs_title;
    lv_obj_t *lbl_subs_count_cap;
    lv_obj_t *lbl_subs_count;
    lv_obj_t *lbl_profile_name_cap;
    lv_obj_t *lbl_profile_name;
    lv_obj_t *lbl_last_rescan_cap;
    lv_obj_t *lbl_last_rescan;
    lv_obj_t *con_messages;
    lv_obj_t *lbl_messages_title;
    lv_obj_t *lbl_notes;
    lv_obj_t *home_5;
} objects_t;
